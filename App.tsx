    ...
    <HashRouter>
      <div className="min-h-screen bg-stone-100/50 font-sans">
        <main className="pb-24">
            <Routes>
                <Route path="/" element={ <HomePage posts={posts} addPost={addPost} openEditModal={openEditModal} currentUser={currentUser} onToggleLike={handleToggleLike} onAddComment={handleAddComment} onOpenLikesModal={openLikesModal} onDeletePost={deletePost} /> } />
                ...
                <Route path="/profile/:userId?" element={ <ProfilePage currentUser={currentUser} allUsers={allUsers} posts={posts} onUpdateUser={updateUser} onLogout={handleLogout} onToggleLike={handleToggleLike} onAddComment={handleAddComment} onOpenLikesModal={openLikesModal} onEditPost={openEditModal} onDeletePost={deletePost}/>} />
